...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link d-none ">Home</a>
      </li><!-- !!!!!!!!!!!!!!!!!!!!!!!          d-none        -->
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <!-- SEARCH FORM -->
    <form class="form-inline ml-3 d-none"><!-- !!!!!!!!!!!!!!!!!!!!!!!          d-none        -->
    ...
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto d-none"><!-- !!!!!!!!!!!!!!!!!!!!!!!          d-none        -->
      <!-- Messages Dropdown Menu -->
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#">
          <i class="far fa-comments"></i>
          <span class="badge badge-danger navbar-badge">666</span>
        </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- SidebarSearch Form -->
      <div class="form-inline d-none"><!-- !!!!!!!!!!!!!!!!!!!!!!!          d-none        -->
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
                ...
                <p>Цвета<i class="right fas fa-angle-left"></i></p>
              </a>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
                ...
                <p>Изделия<i class="right fas fa-angle-left"></i></p>
              </a>
                <ul class="nav nav-treeview">
                    <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
                <i class="nav-icon fas fa-align-left"></i>
                <p>Корзина<i class="right fas fa-angle-left"></i></p>
              </a>
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="{{route('basket.create')}}" class="nav-link">
                          <p>Добавить</p>
                        </a>
                    </li>
                </ul>
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
                ...
                <ul class="nav nav-treeview">
                    <li class="nav-item">
                      <a href="{{route('recall.index')}}" class="nav-link">
                        <p>Все отзывы</p>
                      </a>
                    </li>
                    <li class="nav-item">
                        <a href="{{route('recall.create')}}" class="nav-link">
                          <p>Добавить отзыв</p>
                        </a>
                    </li>
                </ul>
